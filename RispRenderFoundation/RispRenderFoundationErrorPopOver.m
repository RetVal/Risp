...
#import "RispRenderFoundationErrorPopOver.h"

#define kRRFErrorPopOverErrorSpacing 16

@implementation RispRenderFoundationErrorPopOver
...
+ (void) showErrorDescriptions:(NSArray*)errors relativeToView:(NSView*) view
{
    ...
    int viewHeight = kRRFErrorPopOverErrorSpacing * numErrors;
    ...
    for (NSString* err in errors)
    {
        ...
        textField = [[NSTextField alloc] initWithFrame:NSMakeRect(0, viewHeight - (kRRFErrorPopOverErrorSpacing * (errNo + 1)), 1024, kRRFErrorPopOverErrorSpacing)];
