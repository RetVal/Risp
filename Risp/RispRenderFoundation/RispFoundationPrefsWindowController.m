...
@interface RispFoundationPrefsWindowController()
- (BOOL)commitEditingAndDiscard:(BOOL)discard;
@end

@implementation RispFoundationPrefsWindowController
...
- (void)showWindow:(id)sender
{
    ...
    textEditingPrefsViewController = [RispRenderFoundationPreferences sharedInstance].textEditingPrefsViewController;

    fontsAndColoursPrefsViewController = [RispRenderFoundationPreferences sharedInstance].fontsAndColoursPrefsViewController;
...
{
    [[RispRenderFoundationPreferences sharedInstance] revertToStandardSettings:sender];
}
