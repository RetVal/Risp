...
@implementation RispRenderFoundationGutterTextView
...
- (id)initWithFrame:(NSRect)frame
{
	if ((self = [super initWithFrame:frame])) {
        ...
        imgBreakpoint0 = [RispRenderFoundation imageNamed:@"editor-breakpoint-0.png"];
        [imgBreakpoint0 setFlipped:YES];
        imgBreakpoint1 = [RispRenderFoundation imageNamed:@"editor-breakpoint-1.png"];
        [imgBreakpoint1 setFlipped:YES];
        imgBreakpoint2 = [RispRenderFoundation imageNamed:@"editor-breakpoint-2.png"];
		...
		[[self textContainer] setContainerSize:NSMakeSize([[RispRenderFoundationDefaults valueForKey:RispRenderFoundationPrefsGutterWidth] integerValue], FLT_MAX)];
        ...
        if (NO) {
            /* vlidholt/fragaria adopts this approach to try and improve line number accuracy.
              ...
              These settings would need to respond to changes in font / size and be replicated in the RispRenderFoundationTextView.
		...
		[self setTextColor:[NSUnarchiver unarchiveObjectWithData:[RispRenderFoundationDefaults valueForKey:RispRenderFoundationPrefsGutterTextColourWell]]];
...
- (void)mouseDown:(NSEvent *)theEvent
{
    ...
    id delegate = [[RispRenderFoundation currentInstance] objectForKey:RispRenderFoundationFOBreakpointDelegate];
    ...
    RispRenderFoundationLineNumbers* lineNumbers = [[RispRenderFoundation currentInstance] objectForKey:ro_MGSFOLineNumbers];
