...
/**
 `ASUserNotificationFeature` is the real extension for the user notifications. It holds additional features that gives you
 more flexibility using notifications.
 */


NS_CLASS_AVAILABLE(10_7, NA)
@interface ASUserNotificationFeature : NSObject
...
/**
 Specifies the `NSLineBreakMode` for the [ASUserNotification informativeText].
 ...
 `NSLineBreakByTruncatingMiddle`, `NSLineBreakByTruncatingTail` and the `NSLineBreakByClipping` will present the [ASUserNotification informativeText]
 in single line mode. 
