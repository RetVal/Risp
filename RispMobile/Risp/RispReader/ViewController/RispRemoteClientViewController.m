//
//  RispRemoteClientViewController.m
//  Risp
//
...
- (void)_setup
{
    ...
    UIImage *rispCodeImage = [JSQMessagesAvatarFactory avatarWithImage:[UIImage imageNamed:@"RispCode"]
...
{
    [self.delegate didDismissJSQDemoViewController:self];
}
