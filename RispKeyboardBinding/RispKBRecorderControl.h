...
@interface RispKBRecorderControl : NSControl
{
...
// Delegate Methods
@interface NSObject (RispKBRecorderDelegate)
- (BOOL)shortcutRecorder:(RispKBRecorderControl *)aRecorder isKeyCode:(NSInteger)keyCode andFlagsTaken:(NSUInteger)flags reason:(NSString **)aReason;
- (void)shortcutRecorder:(RispKBRecorderControl *)aRecorder keyComboDidChange:(KeyCombo)newKeyCombo;
@end
