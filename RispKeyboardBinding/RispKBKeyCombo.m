...
@implementation RispKBKeyCombo (UserDisplayAdditions)
...
+ (NSDictionary*)_keyCodesDictionary
{
	...
	if( keyCodes == nil )
	{
		NSURL *url = [NSURL fileURLWithPath:[[NSBundle bundleForClass: self] pathForResource: @"RispKBKeyCodes" ofType: @"plist"]];
...
+ (NSString*)_stringForKeyCode: (short)keyCode newKeyCodeMap: (NSDictionary*)dict
{
	...
	//Translate it
	result = [[[RispKBKeyCodeTranslator currentTranslator] translateKeyCode:keyCode] uppercaseString];
